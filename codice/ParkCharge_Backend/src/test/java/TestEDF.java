...
public class TestEDF {
    ...
    public void testScheduling(){
        ...
        assertNull(EDF.getJobPosto(emptyPrenotazioniList, emptyRicaricheList));
        //nessuna ricarica
        assertNull(EDF.getJobPosto(prenotazioniList, emptyRicaricheList));
        //nessuna prenotazione
        assertNull(EDF.getJobPosto(emptyPrenotazioniList, ricaricheList));

        // prenotazioni e ricariche
        assertEquals(1, EDF.getJobPosto(prenotazioniList, ricaricheList).getPosto());
        //ricarica prenotazione 0 completata
        ricaricheList.remove(0);
        assertEquals(3, EDF.getJobPosto(prenotazioniList, ricaricheList).getPosto());
