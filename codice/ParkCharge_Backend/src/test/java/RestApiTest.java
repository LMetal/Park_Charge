        ...
        try {
            ...
            for (Prenotazioni prenotazione : prenotazioni){
                if(prenotazione.getUtente().equals("utenteTest")){
                    prenotazioneVecchia = new Prenotazioni(prenotazione.getId(),prenotazione.getTempo_arrivo(),prenotazione.getTempo_uscita(),prenotazione.getUtente(),prenotazione.getPosto(),prenotazione.getPenale());
                }
            }
